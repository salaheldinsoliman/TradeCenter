...
uint public offeringCount = 0; // keep track of all number
...
function buyOffering(uint _id, uint amount) public payable returns(string memory) {
...
function AddCampaign() public view returns(uint count){
